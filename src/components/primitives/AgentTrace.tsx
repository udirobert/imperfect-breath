 ...
 *
 * Reintegrated post-consolidation: deleted in round 5 with the Results.tsx
 * dashboard, but the primitive itself is on-thesis (trust layer made visible)
 * and dependency-free (~6KB). Wired only into the post-session insight moment.
 */
      ...
      >
        ...
        <span role="status" className="contents">
          {working ? (
            ...
            <span className="text-[13px] font-medium text-muted-foreground">{doneLabel}</span>
          )}
        </span>
