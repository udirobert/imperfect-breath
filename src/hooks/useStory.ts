...
export function useStory() {
  ...
  // Story Protocol client initialization disabled temporarily
  useEffect(() => {
    // TODO: Re-enable Story Protocol when polyfill issues are resolved
    console.log("Story Protocol integration temporarily disabled");
  }, []);
